...
public class RedBall extends Racer
{
    private int speed;
    private Random rand;
     ...
     */
    public RedBall( String rID, int rX, int rY )
    {
        super( rID, rX, rY );
        setRandAndSpeed();
    }
    ...
    public void draw( Graphics g )
    {
        ...
        g.setColor( new Color( 24, 46, 99 ) ); // dark green

        //body
        g.fillOval( startX - 30, startY, 25, 25 );

        //head
        g.fillOval( startX - 0, startY + 0,  0, 0 );

        //flatten bottom
        g.clearRect( startX - 0, startY + 0, 0, 0 );
